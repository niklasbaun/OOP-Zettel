...
public class Aufgabe6_1 {
    public static void main(String[] args) {
        ...
        //create library
        DVD[] dvds = new DVD[0];
        Library our_Library = new Library("Our Library", dvds);
    ...
    public static void testLib(){
        ...
        Library test_library = new Library("My Library", dvdCollection);
        ...
        if (test_library.doIOwn(dvd6) == false){
        ...
        if (test_library.doIOwn(dvd2) == false){
