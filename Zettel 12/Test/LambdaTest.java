...
class LambdaTest {
    ...
    void sortBy() {
        ...
        Lambda.sortBy(test1, (s1, s2) -> s1.length() - s2.length());
    ...
    void listToString() {
        ...
        String test = Lambda.listToString(test1);
